...
},{"jq-cookie":2,"jquery":5}],2:[function(require,module,exports){
(function (global){
...
var vm = new Vue({
  ...
  methods: {
    ...
    btnBack: function() {
      var vm = this;
      if(vm.type=="history") {
        window.location.href = "experienceMoney.html"
      } else {
        window.location.href = "asset_index.html"
      }
    },
    goHistory: function(val){
			window.location.href = "experienceMoney.html?type=history"
		},
    getHistory: function() {
      var vm = this;
      var url = "/api/gift/history/coupon-principal";
      C.myAjax({
          url: url,
          type: "POST"
        },function(data) {
    ...
    getCouponList: function() {
      var vm = this;
      var url = "/api/gift/coupon-principal";
      C.myAjax({
          url: url,
          type: "POST"
        },function(data) {
...
},{"common":1,"jquery":5,"vue":3}],5:[function(require,module,exports){
/*!
