...
gulp.task('buildJs',gulpSync.sync([['lint','browserify'],'rev']));
gulp.task('buildCss',gulpSync.sync([['css'],'rev']));
gulp.task('buildLess',gulpSync.sync([['less'],'rev','rev']));
gulp.task('buildHtml',gulpSync.sync([['copy'],'rev']));

gulp.task('build',gulpSync.sync(['clean',['lint','css','font','less','browserify','images','copy','watch'],'rev','printSuc']));
